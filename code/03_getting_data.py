...
import re           # regex
from BeautifulSoup import BeautifulSoup # a python HTML parser
...
def getStockPrice(symbol): # symbol could be aapl, nflx, ge, etc
    r = requests.get('http://finance.google.com/finance?q='+'-----') # the url of the google finance page goes in here
    b = BeautifulSoup(r.text) # create a beautifulsoup object
    #print b.prettify() # will print the html nicely
    re_tag = re.compile("-----") #this tag finds the tag with the price in it!!!!
